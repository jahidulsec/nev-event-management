    ...
    <View>
      <View style={{ borderRightWidth: 1, borderBottomWidth: 1 }}>
        ...
        <View>
          <FieldGroup>
            ...
            />
            <CustomField name="Work Area" value={data.area.area_name} />
          </FieldGroup>
          <FieldGroup>
            <CustomField name="Designation" value={data.users?.designation} />
            <CustomField name="Region" value={data.area.area?.area_name} />
            <CustomField name="Employee ID" value={data.users?.employee_id} />
          </FieldGroup>
        </View>
      ...
      <View style={{ marginTop: 10 }}>
        <Table>
          ...
          <View>
            {data.event_budgets.length > 0 ? (
              <>
                {data.event_budgets.map((item) => (
      ...
      <View break style={{ marginTop: 10 }}>
        <Table>
          ...
          <View>
            {data.event_consultants ? (
              data.event_consultants.map((item, index) => (
                <TableRow key={item.id}>
                  ...
                  >
                    ...
                    <Field
                      ...
                      value={getTitleCase(
                        item.event_consultant_approvals?.honorarium_check ?? "",
                      )}
                    />
                    <Field
                      name="Consultant Form:"
                      value={getTitleCase(
                        item.event_consultant_approvals
                          ?.consultant_form_attached ?? "",
                      )}
                    />
                    <Field
                      name="Nth Engagement:"
                      value={item.event_consultant_approvals?.nth_engagement}
                    />
                  </View>
                </TableRow>
              ))
            ...
            {eventApprover.length > 0 ? (
              eventApprover.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell style={{ flex: 1 }}>
                    {item.users?.designation.toUpperCase() || "-"}
                  </TableCell>
                  <TableCell style={{ flex: 1 }}>
