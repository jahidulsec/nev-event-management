...
export default function ConsultantSection({
  ...
  form: UseFormReturn<CreateEventPayloadInputType, any, CreateEventPayloadType>;
}) {
  ...
  const eventCreator = form.watch("employee_id");

  const isCreator = user?.employeeId === eventCreator || !eventCreator;
